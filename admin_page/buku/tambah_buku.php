<?php
    ...
    if(isset($_POST["simpan"])){
        ...
        $simpan = simpanBuku($conn, $buku);
        if($simpan["info"]=="sukses"){
            $_SESSION["info"] = $simpan["detail"];
            header("location:./ubah_buku.php?x=buku&idx=" . $simpan["buku_id"]);
        }else{
            $pesan = $simpan["detail"];
        }
    }else{
        $buku["kode_buku"] = kodeBukuOtomatis($conn);
        $buku["nama_buku"] = "";
        $buku["barcode"] = "";
        $buku["isbn"] = "";
        $buku["kategori_buku_id"] = "";
        $buku["nama_rak"] = "";
        $buku["stok_buku"] = "";
    }
?>
                ...
                <div class="row">
                    <div class="col-xs-6">
                        <div class="box box-info">
                            ...
                            <form class="form-horizontal" method="post" action="./tambah_buku.php?x=buku">
                                <div class="box-body">
